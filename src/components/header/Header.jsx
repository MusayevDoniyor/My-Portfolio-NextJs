...
export default function Header() {
  ...
  return (
    <header>
      <nav class="fixed mx-auto border border-[#33353F] top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100">
        <div class="flex container lg:py-4 flex-wrap items-center justify-between mx-auto px-4 py-2">
          <Link class="text-2xl md:text-5xl text-white font-semibold" href="/">
            LOGO
          </Link>
          <div class="mobile-menu block md:hidden">
            <button
              ...
              class="flex items-center px-3 py-2 border rounded border-slate-200 text-slate-200 hover:text-white hover:border-white"
            >
